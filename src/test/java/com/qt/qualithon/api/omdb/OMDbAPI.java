...
public class OMDbAPI {
    ...
    public Movie getMovie(String movieTitle) throws UnsupportedEncodingException {
        //call OMDb movie api
        HttpResponse<JsonNode> response = Unirest.get("https://www.omdbapi.com/?apikey=b569cb4e&t=" + URLEncoder.encode(movieTitle, StandardCharsets.UTF_8.toString())).asJson();
